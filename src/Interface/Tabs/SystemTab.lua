...
-- Coloque aqui o convite do seu servidor, ou defina Config.DiscordLink.
local DEFAULT_DISCORD_LINK = "https://discord.gg/SEU-LINK"
        ...
        Buttons = {
            {
                ...
                Variant = "Tertiary",
                Callback = function()
                    local DiscordLink = Config.DiscordLink or DEFAULT_DISCORD_LINK

                    if DiscordLink == DEFAULT_DISCORD_LINK then
                        WindUI:Notify({
                            Title = "Discord",
